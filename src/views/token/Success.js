import {
  ...
  CFormTextarea,
  CAlert,
  CTable, CTableRow, CTableHeaderCell, CTableDataCell, CTableBody, CTableCaption, CContainer,
} from '@coreui/react';
      ...
      <CRow>
        <CCol xs={12}>
          ...
          <CCard className='mb-4 pb-5'>
            <CCardBody>
              <CTable bordered caption="top" className='custom-table'>
                <CTableCaption className='text-black-color text_align_center'>Your token was created!</CTableCaption>
                <CTableBody>
                  <CTableRow>
              ...
              <div className="mt-3 d-grid gap-3 d-md-flex justify-content-md-center">
                ...
                <button type="button" className="btn-black" onClick={handleCopy} id='copybutton'>
                  Copy address
                </button>
