...
const TokenHome = () => {
  ...
  async function createStandardToken() {
    try {
      ...
      const account = accounts[0];
      console.log(standardTokenFactoryAddr)
          ...
          <CCard className='mb-4 pb-5'>
            <CCardBody>
              <CRow>
                ...
                <CCol>
                  <div className='font-bold text-black-color'>Token Type
              ...
              </CRow>
              {
                ...
                </CRow>
                {
                  tokenType === 'Liquidity Generator Token' ? (
                    ...
                    <>
                    <CRow className='mt-3'>
                      <div className='font-bold text-black-color'>Router
                        <sup className="danger">*</sup>
                      </div>
                    </CRow>
                    <CRow>
                          ...
                          (
                            <div>
                              <div style={{display: 'flex'}}>
                                <div className='col-md-6 text_align_left text-black-color'>TokenName</div>
                                <div className='col-md-6 text_align_right  text-black-color'>{rewardTokenName}</div>
                              </div>
                              <div style={{display: 'flex'}}>
                                <div className='col-md-6 text_align_left text-black-color'>TokenSymbol</div>
                                <div className='col-md-6 text_align_right text-black-color'>{rewardTokenSymbol}</div>
                              </div>
                              <div style={{display: 'flex'}}>
                                <div className='col-md-6 text_align_left text-black-color'>TokenDecimal</div>
                                <div className='col-md-6 text_align_right text-black-color'>{rewardTokenDecimal}</div>
                              </div>
                            </div>
                          ) : (
                            <></>
