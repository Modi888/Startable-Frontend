        ...
        >
          <CCardBody className='bg-white'>
            <CRow>
              ...
              <CCol className="d-md-flex justify-content-md-end text-black-color text-right">
                <div>
                {
                  badgestate === 'Ended' ?
                    <CBadge color='danger'>{badgestate}</CBadge>
                    : badgestate === 'Upcoming' ?
                    <CBadge color='warning' style={{textColor: 'black'}}>Upcoming</CBadge>
            ...
            <CCardText>
              <CRow>
                <CCol>
                  <p className='font-bold text-black-color'>
                    {props.name}
              ...
              <CRow>
                <CCol>
                  <div className='font-bold text-black-color'>
                    Progress ({progress}%)
              ...
              />
              {
                props.list == 1 ?
                  <RowBetween
                    ...
                    childMiddle={<p></p>}
                    childEnd={<button className='card-button' onClick={handleClick}>View Pool</button>}
                  /> :
                  <RowBetween
                    childStart={<p>{/*<p>Sales Starts In: {props.remain}</p>*/}</p>}
                    childMiddle={<p></p>}
